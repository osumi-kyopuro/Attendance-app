...
urlpatterns = [
    ...
    path('delete_menu', views.delete_menu, name='delete_menu'),#データ削除
    path('delete', views.delete, name='delete'),#データ1件削除
    path('add_manyshift', views.add_manyshift, name='add_manyshift'),#データ複数件登録
    path('shift_addition_menu', views.shift_addition_menu, name='shift_addition_menu'),#データ登録メニュー
]